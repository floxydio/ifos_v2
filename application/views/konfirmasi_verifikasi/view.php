...
$(document).ready(function(){
 ...
 <?php
 $tahapan="Verifikasi Assignment";
 ?>

<body> <br />
  <form name="form" method="post" action="<?php echo site_url("konfirmasi/update_multiple/konfirmasi_verifikasi/".$tahapan."/4/verifikasi"); ?>">
...
<br />
 ...
 <script type="text/javascript">
        $(document).ready(function (){
            jQuery("#list").jqGrid({
               	url		: "<?php echo site_url();?>konfirmasi/loadDatasverifikasi",
                mtype : "get",
                datatype: "json",
