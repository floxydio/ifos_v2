...
function tampil_data(dat){
        ...
        $.ajax({
            type	: 'POST',
            url		: "<?php echo site_url(); ?>cekduplikasi/tambahdata/"+dat,
            data	: string,
            cache	: false,
                beforeSend: function(){
...
<a href="<?php echo base_url();?>cekduplikasi"  class="btn btn-primary"> <i class="glyphicon glyphicon-refresh"></i> Refresh</a>
<hr>
    ...
    $(document).ready(function(){
         ...
         "ajax": {
        "url": "<?php echo base_url('cekduplikasi/fetchDatafromDatabase'); ?>",
        "type": "GET"
        },
