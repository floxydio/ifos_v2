 ...
 <b>Data Keuangan</b>
  ...
  <tr>
    ...
    <select name="x_AndaMhs" id="x_AndaMhs" class="js-example-basic-single js-states form-control">
     ...
     ?>
     <option value="single" <?=$a;?>>Single Income</option>
     ...
     <option value="join" <?=$b;?>>Join Income</option>
     <?
      }
     ?>
    </select></div>
...
<input type="text" name="total_penghasilan" id="total_penghasilan" size="20" onKeyUp="kalkulatorTambahData();" style=background-color:grey value="<?php echo $ww['total_penghasilan']; ?>" readonly></div></td></tr>
 <tr>
...
<tr>
    ...
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="biaya_hidup" id="biaya_hidup" onKeyUp="kalkulatorTambahData();"  value="<?php echo $ww['biaya_hidup']; ?>" /></div></td></tr>
<!--tr>
...
<tr-->
    ...
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_pemohon" id="angsuran_pemohon" onKeyUp="kalkulatorTambahData();"  value="<?php echo $ww['angsuran_pemohon']; ?>" /></div></td></tr>
<tr>
	<td width="20%">Angsuran Pemohon di Bank BSM (Existing)</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_bsm" id="angsuran_bsm" onKeyUp="kalkulatorTambahData();"  value="<?php echo $ww['angsuran_bsm']; ?>" /></div></td></tr>
<tr>
	<td width="20%">Angsuran Pasangan</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_pasangan" id="angsuran_pasangan" onKeyUp="kalkulatorTambahData();"  value="<?php echo $ww['angsuran_pasangan']; ?>" /></div></td></tr>
<tr>
...
<input type="text" name="total_penghasilan2" id="total_penghasilan2" onKeyUp="kalkulator();" size="20" style=background-color:grey value="<?php echo $nn['total_penghasilan2']; ?>" readonly></div></td></tr>
<tr>
	<td width=20%>Rekening Kepemilikan</td>
    <td>:</td>
...
<tr>
    ...
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="biaya_hidup1" id="biaya_hidup1" onKeyUp="kalkulator();"  value="<?php echo $ww['biaya_hidup']; ?>" /></div></td></tr>
<!--tr>
<td width="20%">Biaya Lain</td>
   <td width="20">:</td>
    <td>
...
<tr>
    ...
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_pemohon1" id="angsuran_pemohon1"  onKeyUp="kalkulator();" value="<?php echo $ww['angsuran_pemohon']; ?>" /></div></td></tr>
<tr>
	<td width="20%">Angsuran Pemohon di Bank BSM (Existing)</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_bsm1" id="angsuran_bsm1" onKeyUp="kalkulator();"  value="<?php echo $ww['angsuran_bsm']; ?>" /></div></td></tr>
<tr>
	<td width="20%">Angsuran Pasangan</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_pasangan1" id="angsuran_pasangan1"  onKeyUp="kalkulator();" value="<?php echo $ww['angsuran_pasangan']; ?>" /></div></td></tr>
<tr>
	<td width="20%">Sisa Penghasilan</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
