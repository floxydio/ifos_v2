  ...
  placeholder: "Select Data"
  	...
  	$("#tambah").click(function(){
         ...
         $("#nm_agunan1").change(function() {
               var id = $("#nm_agunan1").val();
               var plafon = $("#plafon").val();
      var string = "id="+id+"&plafon="+plafon;
	$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>parameter/parameterjaminan",
			data	: string,
			cache	: true,
			dataType : "json",
			success	: function(data){
               $("#bobot_agunan").val(''+data.bobot_jaminan);
...
<input type="text" name="harga_agunan" id="harga_agunan1"  value=""  onKeyUp="kalkulator();"/>
 ...
 <tr>
    ...
    <td width="5">:</td>
    <td> <div class="col-lg-5">
<input type="text" name="bobot_agunan" id="bobot_agunan"  value="" onKeyUp="kalkulator();" readonly/>%
</div>
</td></tr>
<tr>
