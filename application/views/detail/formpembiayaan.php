     ...
     $("#margin").attr("disabled","disabled");
	  ...
	  //	var string = "rek_induk="+rek_induk+"&no_rek="+no_rek+"&nama_rek="+nama_rek;
       ...
       if(pengalaman==0){
         ...
         $.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>verifikasi/updatebiaya",
			data	: string,
			cache	: false,
			success	: function(data){
...
<tr>
 ...
 <tr>
  ...
  <tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="lama_bank" id="lama_bank"  size="8" maxlength="50" value="<?php echo $db['lama_bank']; ?>"  onKeyUp="return checkInput(this);" /><font color=red>Untuk pengisian lama usaha dibulatkan misalnya 4.5 menjadi 5 </font>(Dalam Tahun)</div></td>
</tr>
...
<tr>
 ...
 <tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
    <select name="sumber" id="sumber" class="js-example-basic-single js-states form-control">
    <option value="0">-Pilih-</option>
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
    <select name="pengalaman" id="pengalaman" class="js-example-basic-single js-states form-control">
    <option value="0">-Pilih-</option>
 ...
 <tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><select name="id_kepemilikan" id="id_kepemilikan" class="js-example-basic-single js-states form-control">
    <option value="0">-Pilih-</option>
