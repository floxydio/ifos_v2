...
?>
  ...
  <tr></tr>
   ...
   <td width=100px >Biaya Notaris </td><td>:</td>
    ...
    <td  width=150px><input type="text" name="no_sp3" id="no_sp3" class="form-control" value="<?php echo $sp3['no_sp3']; ?> " / readonly></td>
    ...
    <td  width=150px><input  type="text" name="tgl_sp3i" id="tgl_sp3i" class="form-control"  size="20" maxlength="50" value="<?php echo $sp3['tgl_sp3']; ?>"/ disabled></td>
