    ...
    $("#angsuran").val(""+plafon);
     ...
     $("#margin").attr("disabled","disabled");
	  ...
	  //	var string = "rek_induk="+rek_induk+"&no_rek="+no_rek+"&nama_rek="+nama_rek;
        var string = "no_aplikasi="+no_aplikasi+"&skim="+skim+"&jenis="+jenis+"&plafon="+plafon+"&jangka_waktu="+jangka_waktu+"&margin="+margin+"&angsuran="+angsuran+"&sumber="+sumber+"&lama_bank="+lama_bank+"&pengalaman="+pengalaman+"&id_kepemilikan="+id_kepemilikan+"&id_tipeproduk="+id_tipeproduk+"&biaya_admin="+biaya_admin+"&biaya_ujrah="+biaya_ujrah;
...
<tr>
    ...
    <select name="id_produk" id="id_produk"  class="js-example-basic-single js-states form-control <?php echo $id_tipeproduk; ?>">
  ...
  <tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
    <select name="skim" id="skim"  class="js-example-basic-single js-states form-control <?php echo $skim; ?>">
    <option value="0">-Pilih-</option>
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
    <select name="jenis" id="jenis" class="js-example-basic-single js-states form-control <?php echo $jenis; ?>">
    <option value="0">-Pilih-</option>
      <?php
 ...
 <tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
          <input type="text" name="plafon" id="plafon" class="form-control <?php echo $plafon; ?>" value="<?php echo $db['plafon'];?>">
  </div></td></tr>
  <tr>
       ...
       $biaya_ujrah = $this->app_model->CariBiayaUjrah($db['id_tipeproduk']);
       	$harga_cicil = $this->app_model->NilaiBiayaEmas($plafon,$db['id_tipeproduk'],'1');
            ...
            if($biaya_admin == '1' and $harga_cicil !='0' ){
             ...
             $harga = number_format($db['biaya_admin']);
                $disabled = "";
            }
             ...
             $hargar = number_format($db['biaya_ujrah']);
                $disabledr = "";
            }
       ?>
          <input type="text" name="biaya_admin" id="biaya_admin" class="form-control <?php echo $biaya_admin; ?>" value="<?php echo $harga;?>" <?php echo $disabled;?>>
  </div></td></tr>
 <tr>
	<td width="20%">Biaya Ujrah</td>
    <td width="5">:</td>
    <td><div class="col-lg-2">
          <input type="text" name="biaya_ujrah" id="biaya_ujrah" class="form-control <?php echo $biaya_ujrah; ?>" value="<?php echo $hargar;?>" <?php echo $disabledr;?>>
  </div></td></tr>
  <tr>
	<td width=20%>Lama Berhubungan Bank</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="lama_bank" id="lama_bank" class="<?php echo $lama_bank; ?>"  size="8" maxlength="50" value="<?php echo $db['lama_bank']; ?>"  onKeyUp="return checkInput(this);" /><font color=red>Untuk pengisian lama usaha dibulatkan misalnya 4.5 menjadi 5 </font>(Dalam Tahun)</div></td>
</tr>
...
<tr>
    ...
    <td width="5">:</td>
    <td> <div class="col-lg-5">
  <input type="text" name="jangka_waktu" id="jangka_waktu"  class="<?php echo $jangka_waktu; ?>"   size="4" maxlength="50"  value="<?php echo $db['jangka_waktu']; ?>"/> <input type="text" name="dalam" id="dalam" size="20" value="<?php echo $dalam; ?>" disabled></div></td></tr>
<tr>
	<td>Margin</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="margin" id="margin" class="<?php echo $margin; ?>"  size="10" maxlength="50" onKeyUp="kalkulatorTambah();" value="<?php echo $db['margin']; ?>"/> %      </td></div></tr>
<tr>
	<td>Angsuran</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="angsuran" id="angsuran"   size="20" maxlength="50" value="<?php echo $db['angsuran']; ?>"  class="form-control <?php echo $angsuran; ?>" /></div>
 ...
 <tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
    <select name="sumber" id="sumber" class="js-example-basic-single js-states form-control <?php echo $sumber; ?>">
    <option value="0">-Pilih-</option>
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
    <select name="pengalaman" id="pengalaman" class="js-example-basic-single js-states form-control <?php echo $pengalaman; ?>">
    <option value="0">-Pilih-</option>
 ...
 <tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><select name="id_kepemilikan" id="id_kepemilikan" class="js-example-basic-single js-states form-control <?php echo $id_kepemilikan; ?>">
    <option value="0">-Pilih-</option>
