...
$(document).ready(function(){
  ...
  placeholder: "Select Data"
 	...
 	$("#simpan").click(function(){
        ...
        var no_tlpperusahaan   = $("#no_tlpperusahaan").val();
	  ...
	  var string = "no_aplikasi="+no_aplikasi+"&jns="+jns+"&nm_perusahaan="+nm_perusahaan+"&bentuk="+bentuk+"&alamat="+alamat+"&kdpos_perusahaan="+kdpos_perusahaan+"&kelurahan_perusahaan="+kelurahan_perusahaan+"&kecamatan_perusahaan="+kecamatan_perusahaan+"&kotamadya_perusahaan="+kotamadya_perusahaan+"&propinsi_perusahaan="+propinsi_perusahaan+"&no_tlpperusahaan="+no_tlpperusahaan+"&no_ext="+no_ext+"&jabatan="+jabatan+"&sektor_ekonomi="+sektor_ekonomi+"&sektor_unggulan="+sektor_unggulan+"&lama_kerja="+lama_kerja+"&jml_karyawan="+jml_karyawan+"&status_usaha="+status_usaha+"&kondisi_usaha="+kondisi_usaha+"&lokasi_usaha="+lokasi_usaha+"&pembukuan="+pembukuan+"&kapasitas="+kapasitas+"&bahan_baku="+bahan_baku+"&kebijakan="+kebijakan;
        ...
        $.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>verifikasi/updatekerjaan_ver",
			data	: string,
			cache	: false,
			success	: function(data){
			                message('success', 'Data berhasil di Update');
          tampil_data('<?php echo $aplikasi;?>','updatepekerjaan','verifikasi','formpekerjaan','2');
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><select name="jns" id="jns" class="js-example-basic-single js-states form-control <?php echo $jns_pekerjaan; ?>">
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="nm_perusahaan" id="nm_perusahaan" size="30" maxlength="50" onkeyup="displayText()" value="<?php echo $dd['nm_perusahaan']; ?>" class="<?php echo $nm_perusahaan; ?>" /></div></td>
</tr>
 <tr>
	<td width=20%>Bentuk Perusahaan</td>
    <td>:</td>
    <td><div class="col-lg-5"><select name="bentuk" id="bentuk" class="js-example-basic-single js-states form-control <?php echo $bentuk; ?>">
    <option value="0">-Pilih-</option>
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><textarea name="alamat" id="alamat"  onkeyup="displayText1()" class="<?php echo $alamat_perusahaan; ?>">
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><input type="search" class='autocomplete nama <?php echo $kdpos_perusahaan; ?>' id="kdpos_perusahaan" name="kdpos_perusahaan" maxlength="50" size="20" value="<?php echo $dd['kdpos_perusahaan']; ?>" /><button type="button"  class="btn btn-info btn-sm" onclick="datakodepos('<?php echo $db['no_aplikasi'];?>','detail','kdposinperusahaan')"><i class="glyphicon glyphicon-plus"></i>Pilih Kodepos</button></div></td>
</tr>
<tr>
	<td width=20%>Kelurahan</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete <?php echo $kelurahan_perusahaan; ?>' name="kelurahan_perusahaan"   id="kelurahan_perusahaan" size="20" maxlength="50"  value="<?php echo $dd['kelurahan_perusahaan']; ?>"/></div></td>
</tr>
<tr>
	<td width=20%>Kecamatan</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete <?php echo $kecamatan_perusahaan; ?>'  name="kecamatan_perusahaan" id="kecamatan_perusahaan" size="20" maxlength="50"  value="<?php echo $dd['kecamatan_perusahaan']; ?>"/></div></td>
</tr>
<tr>
	<td width=20%>Kotamadya / Kabupaten</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete <?php echo $kotamadya_perusahaan; ?>'  name="kotamadya_perusahaan" id="kotamadya_perusahaan" size="20" maxlength="50"  value="<?php echo $dd['kotamadya_perusahaan']; ?>"/></div></td>
</tr>
<tr>
	<td width=20%>Propinsi</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete <?php echo $propinsi_perusahaan; ?>' name="propinsi_perusahaan" id="propinsi_perusahaan"  size="20" maxlength="50"  value="<?php echo $dd['propinsi_perusahaan']; ?>"/></div></td>
</tr>
<tr>
	<td width=20%>Nomor Telepon</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="no_tlpperusahaan" id="no_tlpperusahaan" class="<?php echo $no_tlpperusahaan; ?>"  size="20" maxlength="50" value="<?php echo $dd['no_tlpperusahaan']; ?>" onKeyUp="return checkInput(this);" /></div> Ext
    : <input type="text" name="no_ext" id="no_ext"  size="20" maxlength="50" class="<?php echo $no_ext; ?>" value="<?php echo $dd['no_ext']; ?>" onKeyUp="return checkInput(this);" /></td>
</tr>
<tr>
	<td width=20%>Jabatan</td>
    <td>:</td>
    <td><div class="col-lg-5"><select name="jabatan" id="jabatan" class="js-example-basic-single js-states form-control <?php echo $jabatan; ?>">
    <option value="0">-Pilih-</option>
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><select name="sektor_ekonomi" id="sektor_ekonomi" class="js-example-basic-single js-states form-control <?php echo $sektor_ekonomi; ?>">
    <option value="0">-Pilih-</option>
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><select name="sektor_unggulan" id="sektor_unggulan" class="js-example-basic-single js-states form-control <?php echo $sektor_unggulan; ?>">
    <option value="0">-Pilih-</option>
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="lama_kerja" id="lama_kerja"  size="8" maxlength="50" class="<?php echo $lama_kerja; ?>" value="<?php echo $dd['lama_kerja']; ?>"  onKeyUp="return checkInput(this);" /><font color=red>Untuk pengisian lama usaha dibulatkan misalnya 4.5 menjadi 5 </font>(Dalam Tahun)</div></td>
</tr>
<tr>
	<td width=20%>Jumlah karyawan</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="jml_karyawan" id="jml_karyawan" class="<?php echo $jml_karyawan; ?>"  size="8" maxlength="50" value="<?php echo $dd['jml_karyawan']; ?>"  onKeyUp="return checkInput(this);" />(Banyak Orang)</div></td>
</tr>
<tr></tr><tr></tr><tr></tr>
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><select name="status_usaha" id="status_usaha" class="js-example-basic-single js-states form-control <?php echo $status_usaha; ?>">
    <option value="0">-Pilih-</option>
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><select name="kondisi_usaha" id="kondisi_usaha" class="js-example-basic-single js-states form-control <?php echo $kondisi_usaha; ?>">
    <option value="0">-Pilih-</option>
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><select name="lokasi_usaha" id="lokasi_usaha" class="js-example-basic-single js-states form-control <?php echo $lokasi_usaha; ?>">
    <option value="0">-Pilih-</option>
...
<tr>
    ...
    <td><div class="col-lg-5">
     <select name="pembukuan" id="pembukuan" class="js-example-basic-single js-states form-control <?php echo $pembukuan; ?>">
   <option value="0">-Pilih-</option>
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
     <select name="kapasitas" id="kapasitas" class="js-example-basic-single js-states form-control <?php echo $kapasitas; ?>">
      <option value="0">-Pilih-</option>
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><select name="bahan_baku" id="bahan_baku" class="js-example-basic-single js-states form-control <?php echo $bahan_baku; ?>">
    <option value="0">-Pilih-</option>
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
     <select name="kebijakan" id="kebijakan" class="js-example-basic-single js-states form-control <?php echo $kebijakan; ?>">
      <option value="0">-Pilih-</option>
