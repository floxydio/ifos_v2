...
?><br />
 ...
 <b>Data Keuangan</b>
  ...
  <tr>
    ...
    <select name="s_penghasilan" id="s_penghasilan" class="js-example-basic-single js-states form-control <?php echo $s_penghasilan; ?>">
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
     <select name="jenisp" id="jenisp" class="js-example-basic-single js-states form-control <?php echo $jenisp; ?>">
...
<tr>
    ...
    <td width="20">:</td>
    <td> <div class="col-lg-5">
<input type="text" name="gaji_bulan" id="gaji_bulan" onKeyUp="kalkulatorTambahKeuangan();"  value="<?php echo $ww['gaji_bulan']; ?>" class="<?php echo $gaji_bulan; ?>" /></div></td></tr>
<tr>
	<td width="10%">Penghasilan Tambahan Pemohon</td>

    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_tambahan" id="peng_tambahan" onKeyUp="kalkulatorTambahKeuangan();" value="<?php echo $ww['peng_tambahan']; ?>" class="<?php echo $peng_tambahan; ?>" />
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_utamapasangan" id="peng_utamapasangan" onKeyUp="kalkulatorTambahKeuangan();"  value="<?php echo $ww['peng_utamapasangan']; ?>" class="<?php echo $peng_utamapasangan; ?>" />
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_tambahanpasangan" id="peng_tambahanpasangan" onKeyUp="kalkulatorTambahKeuangan();" value="<?php echo $ww['peng_tambahanpasangan']; ?>" class="<?php echo $peng_tambahanpasangan; ?>"/>
...
<input type="text" name="total_penghasilan" id="total_penghasilan" size="20" onKeyUp="kalkulatorTambahKeuangan();" style=background-color:grey value="<?php echo $ww['total_penghasilan']; ?>" class="<?php echo $total_penghasilan; ?>" readonly></div></td></tr>
 <tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"> <select name="rekening" id="rekening" class="js-example-basic-single js-states form-control <?php echo $rekening; ?>">
...
<tr>
    ...
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="biaya_hidup" id="biaya_hidup" onKeyUp="kalkulatorTambahKeuangan();"  value="<?php echo $ww['biaya_hidup']; ?>" class="<?php echo $biaya_hidup; ?>"/></div></td></tr>
<!--tr>
...
<tr-->
    ...
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_pemohon" id="angsuran_pemohon" onKeyUp="kalkulatorTambahKeuangan();"  value="<?php echo $ww['angsuran_pemohon']; ?>" class="<?php echo $angsuran_pemohon; ?>" /></div></td></tr>
<tr>
	<td width="20%">Angsuran Pemohon di Bank BSM (Existing)</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_bsm" id="angsuran_bsm" onKeyUp="kalkulatorTambahKeuangan();"  value="<?php echo $ww['angsuran_bsm']; ?>" class="<?php echo $angsuran_bsm; ?>" /></div></td></tr>
<tr>
	<td width="20%">Angsuran Pasangan</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_pasangan" id="angsuran_pasangan" onKeyUp="kalkulatorTambahKeuangan();"  value="<?php echo $ww['angsuran_pasangan']; ?>" class="<?php echo $angsuran_pasangan; ?>" /></div></td></tr>
<tr>
...
<tr>
    ...
    <td width="5">:</td>
    <td> <div class="col-lg-5">
<input type="text" name="penjualan_bulan" id="penjualan_bulan" onKeyUp="kalkulatorKeuangan();" value="<?php echo $nn['penjualan_bulan']; ?>" class="<?php echo $penjualan_bulan; ?>"/></div></td></tr>
<tr>
	<td width="10%">HPP</td>

    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="hpp" id="hpp" onKeyUp="kalkulatorKeuangan();" value="<?php echo $nn['hpp']; ?>" class="<?php echo $hpp; ?>" />
 ...
 <tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="total_biaya" id="total_biaya" onKeyUp="kalkulatorKeuangan();" value="<?php echo $nn['total_biaya']; ?>" class="<?php echo $total_biaya; ?>" />
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="penghasilan_bersih" id="penghasilan_bersih" onKeyUp="kalkulatorKeuangan();" style=background-color:grey value="<?php echo $nn['penghasilan_bersih']; ?>" class="<?php echo $penghsilan_bersih; ?>"  />
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_tambahan2" id="peng_tambahan2" onKeyUp="kalkulatorKeuangan();" value="<?php echo $nn['peng_tambahan2']; ?>" class="<?php echo $peng_tamabahan2; ?>" />
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_utamapasangan2" id="peng_utamapasangan2" onKeyUp="kalkulatorKeuangan();" value="<?php echo $nn['peng_utamapasangan2']; ?>" class="<?php echo $peng_utamapasangan2; ?>" />
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_tambahanpasangan2" id="peng_tambahanpasangan2" onKeyUp="kalkulatorKeuangan();" value="<?php echo $nn['peng_tambahanpasangan2']; ?>" class="<?php echo $peng_tambahanpasangan2; ?>"/>
...
<tr>
	<td width=20%>Rekening Kepemilikan</td>
    <td>:</td>
    <td><div class="col-lg-5"><select name="rekening1" id="rekening1" class="js-example-basic-single js-states form-control <?php echo $rekening; ?>">
    <option value="0">-Pilih-</option>
     <?php foreach($listrekening->result() as $w){ ?>
                        <?php if($w->id_rekening == $ww['rekening']){ ?>
                            <option value="<?php echo $w->id_rekening; ?>" selected><?php echo $w->nm_rekening; ?></option>
...
<tr>
    ...
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="biaya_hidup1" id="biaya_hidup1" onKeyUp="kalkulatorKeuangan();"  value="<?php echo $ww['biaya_hidup']; ?>" class="<?php echo $biaya_hidup; ?>" /></div></td></tr>
<!--tr>
<td width="20%">Biaya Lain</td>
   <td width="20">:</td>
    <td>
...
<tr>
    ...
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_pemohon1" id="angsuran_pemohon1"  onKeyUp="kalkulatorKeuangan();" value="<?php echo $ww['angsuran_pemohon']; ?>" class="<?php echo $angsuran_pemohon; ?>"/></div></td></tr>
<tr>
	<td width="20%">Angsuran Pemohon di Bank BSM (Existing)</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_bsm1" id="angsuran_bsm1" onKeyUp="kalkulatorKeuangan();"  value="<?php echo $ww['angsuran_bsm']; ?>" class="<?php echo $angsuran_bsm; ?>" /></div></td></tr>
<tr>
	<td width="20%">Angsuran Pasangan</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_pasangan1" id="angsuran_pasangan1"  onKeyUp="kalkulatorKeuangan();" value="<?php echo $ww['angsuran_pasangan']; ?>" class="<?php echo $angsuran_pasangan; ?>" /></div></td></tr>
<tr>
	<td width="20%">Sisa Penghasilan</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
