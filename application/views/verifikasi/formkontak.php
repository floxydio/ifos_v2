...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="nm_lengkap" id="nm_lengkap" size="30" maxlength="50" value="<?php echo $ww['nm_lengkap_c']; ?>" class="<?php echo $nm_lengkap_c; ?>"   size="50"/></div></td>
</tr>
<tr>
	<td width=20%>Alamat Rumah (Sesuai KTP)</td>
    <td>:</td>
    <td><div class="col-lg-5"><textarea name="alamat" id="alamat" class="<?php echo $alamat_c; ?>">
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><input type="search" class='autocomplete <?php echo $kdpos_c; ?>' id="kdpos_ktp" name="kdpos_ktp" maxlength="50" size="20" value="<?php echo $ww['kdpos_c']; ?>" /><button type="button"  class="btn btn-info btn-sm" onclick="datakodepos('<?php echo $db['no_aplikasi'];?>','detail','kdposin')"><i class="glyphicon glyphicon-plus"></i>Pilih Kodepos</button></div></td>
</tr>
<tr>
	<td width=20%>Kelurahan</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete <?php echo $kelurahan_c; ?>' name="kelurahan_ktp"   id="kelurahan_ktp" size="20" maxlength="50"  value="<?php echo $ww['kelurahan_c']; ?>"/></div></td>
</tr>
<tr>
	<td width=20%>Kecamatan</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete <?php echo $kecamatan_c; ?>'  name="kecamatan_ktp" id="kecamatan_ktp" size="20" maxlength="50"  value="<?php echo $ww['kecamatan_c']; ?>" /></div></td>
</tr>
<tr>
	<td width=20%>Kotamadya / Kabupaten</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete <?php echo $kotamadya_c; ?>'  name="kotamadya_ktp" id="kotamadya_ktp" size="20" maxlength="50"  value="<?php echo $ww['kotamadya_c']; ?>" /></div></td>
</tr>
<tr>
	<td width=20%>Propinsi</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete <?php echo $propinsi_c; ?>' name="propinsi_ktp" id="propinsi_ktp"  size="20" maxlength="50"  value="<?php echo $ww['propinsi_c']; ?>" /></div></td>
</tr>
<tr>
	<td width=20%>No Telepon</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="no_tlp" id="no_tlp"  size="20" maxlength="50"  value="<?php echo $ww['no_tlpc']; ?>" onKeyUp="return checkInput(this);" class="<?php echo $no_tlpc; ?>"/></div></td>
</tr>
<tr>
	<td width=20%>No Handphone 1</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="no_hp1" id="no_hp1"  size="20" maxlength="50" value="<?php echo $ww['no_hp1c']; ?>" onKeyUp="return checkInput(this);" class="<?php echo $no_hp1c; ?>" /></div> No Handphone 2
    : <input type="text" name="no_hp2" id="no_hp2"  size="20" maxlength="50" value="<?php echo $ww['no_hp2c']; ?>" onKeyUp="return checkInput(this);" class="<?php echo $no_hp2c; ?>" /></td>
</tr>
<tr>
