...
?>
  ...
  <tr></tr>
   ...
   <table id="ta">
    ...
    <td  width=150px><input type="text" name="biaya_administrasi" id="biaya_administrasi" value="<?php echo $sp3['biaya_administrasi']; ?>" / required>
  </td>


   	<td width=10px>Perusahaan Asuransi Jiwa</td>
    <td>:</td><td width=150px><input type="search" class='autocomplete nama' id="asuransi_jiwa" name="asuransi_jiwa" maxlength="30" size="30" value="<?php echo $sp3['asuransi_jiwa']; ?>" /></td>




    	<td width=10px>Perusahaan Asuransi Agunan</td>
    <td>:</td><td width=150px><input type="search" class='autocomplete nama' id="asuransi_bakar" name="asuransi_bakar" maxlength="50" size="30" value="<?php echo $sp3['asuransi_bakar']; ?>" /></td>

        </tr>
        <tr>
   <td width=100px >Biaya Notaris </td><td>:</td>

    <td  width=150px> <input type="text" name="biaya_notaris" id="biaya_notaris" value="<?php echo $sp3['biaya_notaris']; ?>" /></td>

       	<td width=100px>Nilai Pertanggungan</td>
    <td>:</td><td width=150px><input type="text" name="nilai_tanggungjiwa" id="nilai_tanggungjiwa" value="<?php echo $sp3['nilai_tanggungjiwa']; ?>" /></td>
          	<td width=100px>Nilai Pertanggungan</td>
    <td>:</td><td width=150px><input type="text" name="nilai_tanggungbakar" id="nilai_tanggungbakar" value="<?php echo $sp3['nilai_tanggungbakar']; ?>" /></td>
    ...
    <td  width=150px> <input type="text" name="biaya_appraisal" id="biaya_appraisal" value="<?php echo $sp3['biaya_appraisal']; ?>" /> </td>

      <td width=100px>Masa Pertanggungan</td>
    <td>:</td>

    <td  width=150px> <input type="text" name="masa_tanggungjiwa" id="masa_tanggungjiwa" value="<?php echo $sp3['masa_tanggungjiwa']; ?>" />Bulan </td>
         <td width=100px>Masa Pertanggungan</td>
    <td>:</td>

    <td  width=150px> <input type="text" name="masa_tanggungbakar" id="masa_tanggungbakar" value="<?php echo $sp3['masa_tanggungbakar']; ?>" />Bulan </td>

        </tr>
        <tr>
           	<td width=100px>Biaya Blokir BPKB</td><td>:</td>

    <td  width=150px><input type="text" name="biaya_blokir" id="biaya_blokir" value="<?php echo $sp3['biaya_blokir']; ?>"/> </td>
         	<td width=100px>Premi</td>
    <td>:</td><td width=150px><input type="text" name="premijiwa" id="premijiwa" value="<?php echo $sp3['premijiwa']; ?>" /></td>
                   	<td width=100px>Premi</td>
    <td>:</td><td width=150px><input type="text" name="premibakar" id="premibakar" value="<?php echo $sp3['premibakar']; ?>" /></td>

        </tr>
        <tr>
           	<td width=100px>Biaya Materai</td><td>:</td>

    <td  width=150px><input type="text" name="biaya_materai" id="biaya_materai" value="<?php echo $sp3['biaya_materai']; ?>"/></td>
         	<td width=100px>Perusahaan Asuransi Penjaminan</td>
    <td>:</td><td width=150px><input type="search" class='autocomplete nama' id="asuransi_jamin" name="asuransi_jamin" maxlength="50" size="30" value="<?php echo $sp3['asuransi_jamin']; ?>" /></td>
          <td width=100px ></td><td></td>
    ...
    <td  width=150px><input type="text" name="biaya_cadangan" id="biaya_cadangan" value="<?php echo $sp3['biaya_cadangan']; ?>"/></td>
         	<td width=100px>Nilai Pertanggungan</td>
    <td>:</td><td width=150px><input type="text" name="nilai_tanggungjamin" id="nilai_tanggungjamin" value="<?php echo $sp3['nilai_tanggungjamin']; ?>" /></td>
          <td width=100px ></td><td></td>

        </tr>
           <tr>
             	<td width=100px>No. SP3</td><td>:</td>

    <td  width=150px><input type="text" name="no_sp3" id="no_sp3" value="<?php echo $sp3['no_sp3']; ?> " /></td>

      <td width=100px>Masa Pertanggungan</td>
    <td>:</td>

    <td  width=150px> <input type="text" name="masa_tanggungjamin" id="masa_tanggungjamin" value="<?php echo $sp3['masa_tanggungjamin']; ?>" />Bulan </td>


        </tr>
           <tr>
       	<td width=100px>Tanggal. SP3</td><td>:</td>

    <td  width=150px>	<input  type="text" name="tgl_sp3" id="tgl_sp3" class="tgl"  size="20" maxlength="50" value="<?php echo $sp3['tgl_sp3']; ?>" placeholder="YYYY-MM-DD"/ readonly></td>

    
      <td width=100px>Premi</td>
    <td>:</td>

    <td  width=150px> <input type="text" name="premijamin" id="premijamin" value="<?php echo $sp3['premijamin']; ?>" /> </td>
  ...
  <tr></tr>
   ...
   <table>
    <tr>
    <td width=1050px align="center"><textarea name="syarat_akad" id="syarat_akad" class="trl"><?php echo $sp3['syarat_akad']; ?></textarea></td>
  ...
  <tr></tr>
   ...
   <table id="ta">
    <tr>
     <td width=1050px align="center"> <textarea name="syarat_pencairan" id="syarat_pencairan" class="textarea2"><?php echo $sp3['syarat_pencairan']; ?></textarea></td><td></td>
  ...
  <tr></tr>
   ...
   <table id="ta">
    <tr>
     <td width=1050px align="center"> <textarea name="syarat_lain" id="syarat_lain" class="textarea2"><?php echo $sp3['syarat_lain']; ?></textarea></td><td></td>
    ...
    <tr>
      ...
      $no_aplikasi = $db['no_aplikasi'];
       echo anchor('sp3/cetaksp3/'.$no_aplikasi,'Export sp3 pembiayaan.doc',array('class' => 'btn btn-primary','data-toggle'=>"tooltip",'data-placement'=>"top",'title'=>"Export sp3 pembiayaan.doc" ));
       }else{
         echo"";
       }
      }
    ...
    <tr>
    <td>
   <button type="button" name="simpansp3" id="simpansp3" class="btn btn-success btn-sm"><i class="glyphicon glyphicon-save"></i> Simpan</button>
