    ...
    <script type="text/javascript">
        function tampil_data(dat) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?php echo site_url(); ?>cekdokumen/tambahdata/" + dat,
                data: string,
                cache: false,
                beforeSend: function() {
    ...
    <body>
        ...
        <div id="view">
            ...
            <a href="<?php echo base_url(); ?>cekdokumen" class="btn btn-primary"> <i class="glyphicon glyphicon-refresh"></i> Refresh</a>
            <hr>
    ...
    <script type="text/javascript">
        ...
        function loadDatatableAjax() {
            ...
            $('#example1').DataTable({
                ...
                "ajax": {
                    "url": "<?php echo base_url('cekdokumen/fetchDatafromDatabase'); ?>",
                    "type": "GET"
                },
            ...
            $(".dataTables_empty").text("Tidak ada Data di tabel.");
