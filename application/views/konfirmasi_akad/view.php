...
$(document).ready(function(){
 ...
 <?php
 $tahapan="Akad Pembiayaan";
 ?>

<body> <br />
  <form name="form" method="post" action="<?php echo site_url("konfirmasi/update_multiple/konfirmasi_akad/".$tahapan."/8/akad"); ?>">
...
<br />
 ...
 <script type="text/javascript">
        $(document).ready(function (){
            jQuery("#list").jqGrid({
               	url		: "<?php echo site_url();?>konfirmasi/loadDataakad",
                mtype : "get",
                datatype: "json",
