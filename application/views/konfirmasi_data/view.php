...
$(document).ready(function(){
 ...
 <?php
 $tahapan="Detail Data Entry";
 ?>

<body> <br />
  <form name="form" method="post" action="<?php echo site_url("konfirmasi/update_multiple/konfirmasi_data/".$tahapan."/3/dataentry"); ?>">
...
<br />
 ...
 <script type="text/javascript">
        $(document).ready(function (){
            jQuery("#list").jqGrid({
               	url		: "<?php echo site_url();?>konfirmasi/loadDatadata",
                mtype : "get",
                datatype: "json",
