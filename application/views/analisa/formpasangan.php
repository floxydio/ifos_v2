...
$(document).ready(function(){
  ...
  placeholder: "Select Data"
    ...
    $("#simpan").click(function(){
      ...
      $.ajax({
            type	: 'POST',
            url		: "<?php echo site_url(); ?>verifikasi/updatepas_ver",
            data	: string,
            cache	: false,
            success	: function(data){
                  		   message('success', 'Data berhasil di tambah');
                  tampil_data('<?php echo $aplikasi;?>','updatepasangan','verifikasi','formpasangan','2');
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="nm_lengkap" id="nm_lengkap" size="30" maxlength="50" value="<?php echo $ww['nm_lengkap']; ?>" class="<?php echo $nm_lengkap; ?>" readonly/></div></td>
</tr>
<tr>
    <td width=20%>Jenis Pekerjaan</td>
    <td>:</td>
    <td><div class="col-lg-5"><select name="id_jabatan" id="id_jabatan" class="js-example-basic-single js-states form-control <?php echo $id_jabatan; ?>" disabled>
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="id_cardnikah" id="id_cardnikah"  size="50" maxlength="50" value="<?php echo $ww['id_cardnikah']; ?>" class="<?php echo $id_cardnikah; ?>" readonly/></div></td>
</tr>
<tr>
    <td width=20%>No.KTP/SIM</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="no_identitas" id="no_identitas"  size="50" maxlength="50" value="<?php echo $ww['no_identitas']; ?>"  onKeyUp="return checkInput(this);"  class="<?php echo $no_identitas; ?>" readonly/></div></td>
</tr>

<tr>
    <td width=20%>Jenis ID Card</td>
    <td>:</td>
    <td><div class="col-lg-5"><select name="id_card" id="id_card" class="js-example-basic-single js-states form-control <?php echo $id_card; ?>" disabled>
    <option value="0">-Pilih-</option>
        <?php
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="tempat_lahir" id="tempat_lahir"  size="30" value="<?php echo $ww['tempat_lahir']; ?>" maxlength="50" class="<?php echo $tempat_lahir; ?>" readonly/></div> Tanggal Lahir (yyyy-mm-dd)
    : <input type="text" name="tanggal_lahir" id="tanggal_lahir" value="<?php echo $ww['tanggal_lahir']; ?>" size="20" maxlength="50" class="<?php echo $tanggal_lahir; ?>" readonly/>
</tr>

 <tr>
    <td width=20%>Alamat Rumah (Sesuai KTP)</td>
    <td>:</td>
    <td><div class="col-lg-5"><textarea name="alamat" id="alamat" class="form-control <?php echo $alamat; ?>" onkeyup="displayText1()" readonly>
    <?php echo $ww['alamat']; ?></textarea></div><br /> </td>
</tr>
<tr>
 	<td width=20%>Kodepos</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="search" class='autocomplete nama <?php echo $kdpos_ktp; ?>' id="kdpos_ktp" name="kdpos_ktp" maxlength="50" size="20" value="<?php echo $ww['kdpos_ktp']; ?>" readonly/></div</td>
</tr>
<tr>
    <td width=20%>Kelurahan</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete <?php echo $kelurahan_ktp; ?>' name="kelurahan_ktp"   id="kelurahan_ktp" size="20" maxlength="50"  value="<?php echo $ww['kelurahan_ktp']; ?>" readonly/></div></td>
</tr>
<tr>
    <td width=20%>Kecamatan</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete <?php echo $kecamatan_ktp; ?>'  name="kecamatan_ktp" id="kecamatan_ktp" size="20" maxlength="50"  value="<?php echo $ww['kecamatan_ktp']; ?>" readonly/></div></td>
</tr>
<tr>
    <td width=20%>Kotamadya / Kabupaten</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete '  name="kotamadya_ktp" id="kotamadya_ktp" size="20" maxlength="50"  value="<?php echo $ww['kotamadya_ktp']; ?>" readonly/></div></td>
</tr>
<tr>
    <td width=20%>Propinsi</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete <?php echo $propinsi_ktp; ?>' name="propinsi_ktp" id="propinsi_ktp"  size="20" maxlength="50"  value="<?php echo $ww['propinsi_ktp']; ?>" readonly/></div></td>
</tr>

<tr>
    <td width=20%>Alamat Rumah Tinggal</td>
    <td>:</td>
    <td><div class="col-lg-5"><textarea name="alamat_tinggal" id="alamat_tinggal" class="form-control <?php echo $alamat_tinggal; ?>" readonly>
    <?php echo $ww['alamat_tinggal']; ?></textarea> </div></td>
</tr>
<tr>
    <td width=20%>Kodepos</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="search" class='autocomplete1 nama <?php echo $kdpos_tinggal; ?>' id="kdpos_tinggal" name="kdpos_tinggal" maxlength="50" size="20" value="<?php echo $ww['kdpos_tinggal']; ?>" readonly/></div</td>
</tr>
<tr>
    <td width=20%>Kelurahan</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete1 <?php echo $kelurahan_tinggal; ?>' name="kelurahan_tinggal"   id="kelurahan_tinggal" size="20" maxlength="50"  value="<?php echo $ww['kelurahan_tinggal']; ?>" readonly/></div></td>
</tr>
<tr>
    <td width=20%>Kecamatan</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete1 <?php echo $kecamatan_tinggal; ?>'  name="kecamatan_tinggal" id="kecamatan_tinggal" size="20" maxlength="50"  value="<?php echo $ww['kecamatan_tinggal']; ?>" readonly/></div></td>
</tr>
<tr>
    <td width=20%>Kotamadya / Kabupaten</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete1 <?php echo $kotamadya_tinggal; ?>'  name="kotamadya_tinggal" id="kotamadya_tinggal" size="20" maxlength="50"  value="<?php echo $ww['kotamadya_tinggal']; ?>" readonly/></div></td>
</tr>
<tr>
    <td width=20%>Propinsi</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class='autocomplete1 <?php echo $propinsi_tinggal; ?>' name="propinsi_tinggal" id="propinsi_tinggal"  size="20" maxlength="50"  value="<?php echo $ww['propinsi_tinggal']; ?>" readonly/></div></td>
</tr>
<tr>
    <td width=20%>No Telepon Yang Bisa Dihubungi</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="no_tlp" id="no_tlp"  size="20" maxlength="50" value="<?php echo $ww['no_tlp']; ?>" onKeyUp="return checkInput(this);" class="<?php echo $no_tlp; ?>" readonly/></div></td>
</tr>
<tr>
    <td width=20%>No Handphone 1</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" name="no_hp1" id="no_hp1"  size="20" maxlength="50" value="<?php echo $ww['no_hp1']; ?>" onKeyUp="return checkInput(this);" class="<?php echo $no_hp1; ?>" readonly/></div> No Handphone 2
    : <input type="text" name="no_hp2" id="no_hp2"  size="20" maxlength="50" value="<?php echo $ww['no_hp2']; ?>" onKeyUp="return checkInput(this);" class="<?php echo $no_hp2; ?>" readonly/>
</tr>
  </table>
   </form>
<tr></tr><tr></tr> <tr></tr> <tr></tr>
