...
$(document).ready(function(){
 ...
 <?php
 $tahapan="SP3 Pembiayaan";
 ?>

<body> <br />
  <form name="form" method="post" action="<?php echo site_url("konfirmasi/update_multiple/konfirmasi_sp3/".$tahapan."/7/sp3"); ?>">
...
<br />
 ...
 <script type="text/javascript">
        $(document).ready(function (){
            jQuery("#list").jqGrid({
               	url		: "<?php echo site_url();?>konfirmasi/loadDatasp3",
                mtype : "get",
                datatype: "json",
