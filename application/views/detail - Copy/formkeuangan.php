...
<tr>
    ...
    <td width="20">:</td>
    <td> <div class="col-lg-5">
<input type="text" name="gaji_bulan" id="gaji_bulan" onKeyUp="kalkulatorTambahKeuangan();"  value="<?php echo $ww['gaji_bulan']; ?>" /></div></td></tr>
<tr>
	<td width="10%">Penghasilan Tambahan Pemohon</td>

    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_tambahan" id="peng_tambahan" onKeyUp="kalkulatorTambahKeuangan();" value="<?php echo $ww['peng_tambahan']; ?>" />
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_utamapasangan" id="peng_utamapasangan" onKeyUp="kalkulatorTambahKeuangan();"  value="<?php echo $ww['peng_utamapasangan']; ?>" />
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_tambahanpasangan" id="peng_tambahanpasangan" onKeyUp="kalkulatorTambahKeuangan();" value="<?php echo $ww['peng_tambahanpasangan']; ?>"/>
