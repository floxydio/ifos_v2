        ...
        $.messager.show({
          ...
          var formData = new FormData($('.myForm')[0]);
        	...
        	success	: function(msg){
                 tampil_data('<?php echo $gg['no_aplikasi']; ?>','updatedokumen','detail','formdokumen','1');
                  $("#mymodal").modal("hide"); 
       	},
...
<form method="POST" class="myForm" enctype="multipart/form-data">
 ...
 <tr>
    ...
    <td>:</td>
    <td><input type="text" name="nm_dok" id="nm_dok" value="<?php echo $gg['nm_dokumen']; ?>" size="50" maxlength="50" disabled/></td>
</tr>
<tr>
