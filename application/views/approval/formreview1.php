...
<form class="form-horizontal" id="dataTable">
  ...
  <td align="center" width="60%">
    ...
    <tr>
   	<td width=100px>No Cabang  </td><td>:</td><td width=150px ><input type="hidden" name="appr" id="appr" value="<?php echo $db['approve']; ?>"/>  <input type="hidden" name="thp" id="thp" size="30" maxlength="50" value="<?php echo $tahapantab;?>" /><input type="hidden" name="plafon_biaya" id="plafon_biaya" value="<?php echo $plafon; ?>"/><input type="hidden" name="hasil" id="hasil" value="<?php echo $db['pic_pemutus']; ?>"/><input type="hidden" name="scoring" id="scoring" value="<?php echo $db['scoring']; ?>"/><input type="hidden" name="no_aplikasi" id="no_aplikasi" value="<?php echo $db['no_aplikasi']; ?>"/>
...
?>
 ...
 <?php
  ...
  <button type="button" class="btn btn-primary btn-sm"><i class="glyphicon glyphicon-user"></i>Keputusan Komite Pembiayaan</button>
    ...
    <td  width=100px><textarea name="nm_memo" id="nm_memo" class="textarea1" readonly><?php echo $db['ket']; ?></textarea></td>
