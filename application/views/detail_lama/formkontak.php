...
$(document).ready(function(){
	...
	$("#simpan").click(function(){
        ...
        var no_hp2   = $("#no_hp2").val();
      	var string = "no_aplikasi="+no_aplikasi+"&nm_lengkap="+nm_lengkap+"&alamat="+alamat+"&kdpos_ktp="+kdpos_ktp+"&kelurahan_ktp="+kelurahan_ktp+"&kecamatan_ktp="+kecamatan_ktp+"&propinsi_ktp="+propinsi_ktp+"&no_tlp="+no_tlp+"&no_hp1="+no_hp1+"&no_hp2="+no_hp2+"&kotamadya_ktp="+kotamadya_ktp;
        ...
        if(no_hp1.length==0){
			...
			return false;
         	...
         	$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>detail/updatedarurat",
			data	: string,
			cache	: false,
