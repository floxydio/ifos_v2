  ...
  placeholder: "Select Data"
  	...
  	$("#tambah").click(function(){
		...
		var string = "nm_agunan="+nm_agunan+"&harga_agunan="+harga_agunan+"&no_aplikasi="+no_aplikasi;
        ...
        if(harga_agunan.length==0){
	  	...
	  	$.ajax({
			type	: 'POST',
			url		: "<?php echo site_url(); ?>detail/updateagunan",
			data	: string,
			cache	: false,
		...
		var string ="id_jaminand="+id_jaminand+"&no_aplikasi="+no_aplikasi+"&nm_agunan="+nm_agunan+"&kondisi_kendaraan="+kondisi_kendaraan+"&id_jaminand="+id_jaminand+"&tujuan_kendaraan="+tujuan_kendaraan+"&negara_kendaraan="+negara_kendaraan+"&merk="+merk+"&model="+model+"&tipe="+tipe+"&no_mesin="+no_mesin+"&no_rangka="+no_rangka+"&no_bpkb="+no_bpkb+"&tgl_bpkb="+tgl_bpkb+"&alamat_kendaraan="+alamat_kendaraan+"&kdpos_kendaraan="+kdpos_kendaraan+"&kelurahan_kendaraan="+kelurahan_kendaraan+"&kecamatan_kendaraan="+kecamatan_kendaraan+"&kotamadya_kendaraan="+kotamadya_kendaraan+"&propinsi_kendaraan="+propinsi_kendaraan;
   	...
   	$("#simpancash").click(function(){
		...
		var string ="id_jaminand="+id_jaminand+"&no_aplikasi="+no_aplikasi+"&nm_agunan="+nm_agunan+"&atas_nama="+atas_nama+"&no_bilyet="+no_bilyet+"&no_seri="+no_seri+"&tgl_cash="+tgl_cash+"&jumlah="+jumlah+"&tgl_valuta="+tgl_valuta+"&tgl_jatuhtempo="+tgl_jatuhtempo;
		...
		var string ="id_jaminand="+id_jaminand+"&no_aplikasi="+no_aplikasi+"&nm_agunan="+nm_agunan+"&nm_sk="+nm_sk+"&no_rekening="+no_rekening+"&nm_bendahara="+nm_bendahara+"&payroll="+payroll+"&no_sk="+no_sk+"&no_pks="+no_pks+"&tgl_sk="+tgl_sk;
		...
		var string ="id_jaminand="+id_jaminand+"&no_aplikasi="+no_aplikasi+"&nm_agunan="+nm_agunan+"&jenis_alat="+jenis_alat+"&atas_nama="+atas_nama+"&negara_mesin="+negara_mesin+"&merk_mesin="+merk_mesin+"&tahun="+tahun+"&no_faktur="+no_faktur+"&bukti_pemilik="+bukti_pemilik+"&no_pemilik="+no_pemilik;
		...
		var string ="id_jaminand="+id_jaminand+"&no_aplikasi="+no_aplikasi+"&nm_agunan="+nm_agunan+"&karat="+karat+"&sertifikat_perusahaan="+sertifikat_perusahaan+"&berat="+berat+"&no_sertifikat="+no_sertifikat+"&no_faktur="+no_faktur;
 	...
 	$("#simpanpiutang").click(function(){
		...
		var string ="id_jaminand="+id_jaminand+"&no_aplikasi="+no_aplikasi+"&nm_agunan="+nm_agunan+"&nm_pihak="+nm_pihak+"&no_kontrak="+no_kontrak+"&tgl_piutang="+tgl_piutang+"&pihak_hutang="+pihak_hutang;
		...
		var string ="id_jaminand="+id_jaminand+"&no_aplikasi="+no_aplikasi+"&nm_agunan="+nm_agunan+"&atas_nama="+atas_nama+"&nm_agunan="+nm_agunan+"&alamat_kendaraan="+alamat_kendaraan+"&kdpos_kendaraan="+kdpos_kendaraan+"&kelurahan_kendaraan="+kelurahan_kendaraan+"&kecamatan_kendaraan="+kecamatan_kendaraan+"&kotamadya_kendaraan="+kotamadya_kendaraan+"&propinsi_kendaraan="+propinsi_kendaraan+"&status="+status+"&no_sertifikat="+no_sertifikat+"&tgl_terbit="+tgl_terbit+"&hubnasabah="+hubnasabah;
...
<div style="float:left; padding-bottom:5px;">
 ...
 <div class="table-responsive"><table class="table table bordered" width="100%">
<tr>
	<th>No</th>
    <th>Nama Agunan</th>
    <th>harga Agunan</th>
   ...
   if($listdetailjaminan->num_rows() > 0){
    ...
    ?>
        ...
        <td><?php echo $t->harga_agunan;?></td>
         <td><font color=blue><?php echo $t->status_jaminan;?></font></td>
...
<fieldset class="atas">
  ...
  <tr>
    ...
    <td><div class="col-lg-5"><input type="hidden" name="no_aplikasi" id="no_aplikasi" size="30" maxlength="50" value="<?php echo $zz['no_aplikasi']; ?>" /></div></td>
...
<tr>
    ...
    <td width="5">:</td>
    <td>
<input type="text" name="harga_agunan" id="harga_agunan1"  value="" />
...
<fieldset class="atas">
 ...
 <table id="data" width="90%">
  ...
  <tr><tH>
  <legend>Detail Kendaraan</legend><br /></tH>
  </tr>
  <tr>
...
<tr>
 ...
 <tr>
    ...
    <td>:</td>
    <td><input type="text" name="tgl_valuta" id="tgl_valuta"  size="20" maxlength="50"/></td>
</tr>
<tr>
	<td>Jatuh Tempo Tanggal</td>
    <td>:</td>
    <td><input type="text" name="tgl_jatuhtempo" id="tgl_jatuhtempo"  size="20" maxlength="50"/></td>
</tr>
...
<fieldset class="atas">
 ...
 <table id="data" width="90%">
  ...
  <tr>
   ...
   <tr><tH>
  <legend>Detail Emas</legend><br /></tH>
  </tr>
  <tr>
...
<fieldset class="atas">
 ...
 <table id="data" width="90%">
  ...
  <tr>
   ...
   <tr><tH>
  <legend>Detail Piutang</legend><br /></tH>
  </tr>
  <tr>
...
<fieldset class="atas">
 ...
 <table id="data" width="90%">
  ...
  <tr>
   ...
   <tr><tH>
  <legend>Detail Tanah Kosong</legend><br /></tH>
  </tr>
  <tr>
