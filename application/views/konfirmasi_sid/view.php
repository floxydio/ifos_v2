...
$(document).ready(function(){
 ...
 <?php
 $tahapan="SID Duplikasi";
 ?>

<body> <br />
  <form name="form" method="post" action="<?php echo site_url("konfirmasi/update_multiple/konfirmasi_sid/".$tahapan."/2/sid"); ?>">
...
<br />
 ...
 <script type="text/javascript">
        $(document).ready(function (){
            jQuery("#list").jqGrid({
               	url		: "<?php echo site_url();?>konfirmasi/loadDatasid",
                mtype : "get",
                datatype: "json",
          ...
          $('#list').jqGrid('filterToolbar');
			...
			$.messager.show({
				title:'Info',
				msg:'Maaf, PIC Tidak Boleh Kosong',
				timeout:2000,
				showType:'fade',
                 style:{
                    right:'',
