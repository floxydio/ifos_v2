...
<a href="<?php echo base_url();?>verifikasi"  class="btn btn-primary"> <i class="glyphicon glyphicon-refresh"></i> Refresh</a>
<hr>
    ...
    $(document).ready(function(){
         ...
         "ajax": {
        "url": "<?php echo base_url('verifikasi/fetchDatafromDatabase'); ?>",
        "type": "GET"
        },
