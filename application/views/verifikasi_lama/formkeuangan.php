...
success: function(htmldataumum) {
 ...
 function simpannasabahDetail(no_aplikasi,nama,nama_verifikasi,master_input,inputdata,kolom,field,form,tabel){
    var no_aplikasi =no_aplikasi;
       var master_input = master_input;
    var master_verifikasi = $("#"+nama_verifikasi).val();
var verifikasi = $("#"+nama).val();
var inputan = inputdata;
var kolom = kolom;
var field = field;
var form = form;
	var data = "no_aplikasi="+no_aplikasi+"&verifikasi="+verifikasi+"&inputan="+inputan+"&kolom="+kolom+"&field="+field+"&form="+form+"&master_input="+master_input+"&master_verifikasi="+master_verifikasi;
...
type: 'POST',
dataType:'html',
url: "<?php echo site_url(); ?>verifikasi/updatebarudetail/"+nama+"/"+tabel,
data: data,
beforeSend: function(){
//document.getElementById('uploadProcessDetailRincian').style.display= 'block';
//$('#datanasabah').css("opacity",".2");
...
?><br />
 ...
 <b>Data Keuangan</b>
  ...
  <tr>
    ...
    <select name="s_penghasilan" id="s_penghasilan" class="js-example-basic-single js-states form-control">
...
<tr>
    ...
    <td width="20">:</td>
    <td> <div class="col-lg-5">
<input type="text" name="gaji_bulan" id="gaji_bulan"   value="<?php echo $ww['gaji_bulan']; ?>"  onchange="javascript:simpannasabahDetail('<?php echo $db['no_aplikasi']; ?>','gaji_bulan','jenisp','<?php echo $db['jenisp']; ?>','<?php echo $ww['gaji_bulan']; ?>','Gaji Per Bulan','gaji_bulan','Data Keuangan','tb_keuangan')"/></div></td></tr>
<tr>
	<td width="10%">Penghasilan Tambahan Pemohon</td>

    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_tambahan" id="peng_tambahan"  onchange="javascript:simpannasabahDetail('<?php echo $db['no_aplikasi']; ?>','peng_tambahan','jenisp','<?php echo $db['jenisp']; ?>','<?php echo $ww['peng_tambahan']; ?>','Penghasilan Tambahan','peng_tambahan','Data Keuangan','tb_keuangan')" value="<?php echo $ww['peng_tambahan']; ?>" />
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_utamapasangan" id="peng_utamapasangan" onchange="javascript:simpannasabahDetail('<?php echo $db['no_aplikasi']; ?>','peng_utamapasangan','jenisp','<?php echo $db['jenisp']; ?>','<?php echo $ww['peng_utamapasangan']; ?>','Penghasilan Utama Pasangan','peng_utamapasangan','Data Keuangan','tb_keuangan')" value="<?php echo $ww['peng_utamapasangan']; ?>" />
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_tambahanpasangan" id="peng_tambahanpasangan" onchange="javascript:simpannasabahDetail('<?php echo $db['no_aplikasi']; ?>','peng_tambahanpasangan','jenisp','<?php echo $db['jenisp']; ?>','<?php echo $ww['peng_tambahanpasangan']; ?>','Penghasilan Tambahan Pasangan','peng_tambahanpasangan','Data Keuangan','tb_keuangan')" value="<?php echo $ww['peng_tambahanpasangan']; ?>"/>
...
<input type="text" name="total_penghasilan" id="total_penghasilan" size="20" onKeyUp="kalkulatorTambahKeuangan();" style=background-color:grey value="<?php echo $ww['total_penghasilan']; ?>" readonly></div></td></tr>
 <tr>
	<td width=20%>Rekening Kepemilikan</td>
    <td>:</td>
    <td><div class="col-lg-5"> <select name="rekening" id="rekening" class="js-example-basic-single js-states form-control">
...
<tr>
    ...
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="biaya_hidup" id="biaya_hidup" onKeyUp="kalkulatorTambahKeuangan();"  value="<?php echo $ww['biaya_hidup']; ?>" /></div></td></tr>
<!--tr>
...
<tr-->
    ...
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_pemohon" id="angsuran_pemohon" onKeyUp="kalkulatorTambahKeuangan();"  value="<?php echo $ww['angsuran_pemohon']; ?>" /></div></td></tr>
<tr>
	<td width="20%">Angsuran Pemohon di Bank BSM (Existing)</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_bsm" id="angsuran_bsm" onKeyUp="kalkulatorTambahKeuangan();"  value="<?php echo $ww['angsuran_bsm']; ?>" /></div></td></tr>
<tr>
	<td width="20%">Angsuran Pasangan</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_pasangan" id="angsuran_pasangan" onKeyUp="kalkulatorTambahKeuangan();"  value="<?php echo $ww['angsuran_pasangan']; ?>" /></div></td></tr>
<tr>
	<td width="20%">Sisa Penghasilan</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="sisa_penghasilan" id="sisa_penghasilan" size="20" style=background-color:grey value="<?php echo $ww['sisa_penghasilan']; ?>" readonly></div></td></tr>
...
<tr>
    ...
    <td width="5">:</td>
    <td> <div class="col-lg-5">
<input type="text" name="penjualan_bulan" id="penjualan_bulan" onKeyUp="kalkulatorKeuangan();" value="<?php echo $nn['penjualan_bulan']; ?>" /></div></td></tr>
<tr>
	<td width="10%">HPP</td>

    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="hpp" id="hpp" onKeyUp="kalkulatorKeuangan();" value="<?php echo $nn['hpp']; ?>" />
 ...
 <tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="total_biaya" id="total_biaya" onKeyUp="kalkulatorKeuangan();" value="<?php echo $nn['total_biaya']; ?>" />
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="penghasilan_bersih" id="penghasilan_bersih" onKeyUp="kalkulatorKeuangan();" style=background-color:grey value="<?php echo $nn['penghasilan_bersih']; ?>"  />
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_tambahan2" id="peng_tambahan2" onKeyUp="kalkulatorKeuangan();" value="<?php echo $nn['peng_tambahan2']; ?>" />
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_utamapasangan2" id="peng_utamapasangan2" onKeyUp="kalkulatorKeuangan();" value="<?php echo $nn['peng_utamapasangan2']; ?>" />
...
<tr>
    ...
    <td width="5">:</td>
    <td><div class="col-lg-5">
<input type="text" name="peng_tambahanpasangan2" id="peng_tambahanpasangan2" onKeyUp="kalkulatorKeuangan();" value="<?php echo $nn['peng_tambahanpasangan2']; ?>" />
...
<input type="text" name="total_penghasilan2" id="total_penghasilan2" onKeyUp="kalkulatorKeuangan();" size="20" style=background-color:grey value="<?php echo $nn['total_penghasilan2']; ?>" readonly></div></td></tr>
<tr>
	<td width=20%>Rekening Kepemilikan</td>
    <td>:</td>
    <td><div class="col-lg-5"><select name="rekening1" id="rekening1" class="js-example-basic-single js-states form-control">
    <option value="0">-Pilih-</option>
     <?php foreach($listrekening->result() as $w){ ?>
                        <?php if($w->id_rekening == $ww['rekening']){ ?>
                            <option value="<?php echo $w->id_rekening; ?>" selected><?php echo $w->nm_rekening; ?></option>
...
<tr>
    ...
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="biaya_hidup1" id="biaya_hidup1" onKeyUp="kalkulatorKeuangan();"  value="<?php echo $ww['biaya_hidup']; ?>" /></div></td></tr>
<!--tr>
<td width="20%">Biaya Lain</td>
   <td width="20">:</td>
    <td>
...
<tr>
    ...
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_pemohon1" id="angsuran_pemohon1"  onKeyUp="kalkulatorKeuangan();" value="<?php echo $ww['angsuran_pemohon']; ?>" /></div></td></tr>
<tr>
	<td width="20%">Angsuran Pemohon di Bank BSM (Existing)</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_bsm1" id="angsuran_bsm1" onKeyUp="kalkulatorKeuangan();"  value="<?php echo $ww['angsuran_bsm']; ?>" /></div></td></tr>
<tr>
	<td width="20%">Angsuran Pasangan</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="angsuran_pasangan1" id="angsuran_pasangan1"  onKeyUp="kalkulatorKeuangan();" value="<?php echo $ww['angsuran_pasangan']; ?>" /></div></td></tr>
<tr>
	<td width="20%">Sisa Penghasilan</td>
    <td width="20">:</td>
    <td><div class="col-lg-5">
<input type="text" name="sisa_penghasilan1" id="sisa_penghasilan1" style=background-color:grey value="<?php echo $ww['sisa_penghasilan']; ?>" readonly/></div></td></tr>
...
$(document).ready(function(){
 $("#jenisp").change(function(){
       if ($("#jenisp").val() =="tetap") {
        ...
        kalkulatorTambahKeuangan();
         kalkulatorKeuangan();
                   simpannasabah('jenisp','<?php echo $db['jenisp']; ?>','Jenis Penghasilan','jenisp','Data Keuangan','tb_pembiayaan');
     ...
     $("#s_penghasilan").change(function() {
       ...
       peng_utamapasangan2.removeAttr('disabled');
        ...
        var jenispeng = "<?php echo $db['s_penghasilan'];?>";
        simpannasabah('s_penghasilan','<?php echo $db['s_penghasilan']; ?>','Sumber Penghasilan','s_penghasilan','Data Keuangan','tb_pembiayaan');
        ...
        peng_tambahanpasangan2.attr('disabled','disabled');
            simpannasabah('s_penghasilan','<?php echo $db['s_penghasilan']; ?>','Sumber Penghasilan','s_penghasilan','Data Keuangan','tb_pembiayaan');
                  // simpannasabahDetail('<?php echo $db['no_aplikasi']; ?>','peng_utamapasangan','s_penghasilan','<?php echo $db['s_penghasilan']; ?>','<?php echo $ww['peng_utamapasangan']; ?>','Peng. Utama Pasangan','peng_utamapasangan','Data Keuangan','tb_keuangan');
                      //   simpannasabahDetail('<?php echo $db['no_aplikasi']; ?>','peng_utamapasangan2','s_penghasilan','<?php echo $db['s_penghasilan']; ?>','<?php echo $ww['peng_utamapasangan2']; ?>','Peng. Utama Pasangan 2','peng_utamapasangan2','Data Keuangan','tb_keuangan');
                      //          simpannasabahDetail('<?php echo $db['no_aplikasi']; ?>','peng_tambahanpasangan','s_penghasilan','<?php echo $db['s_penghasilan']; ?>','<?php echo $ww['peng_tambahanpasangan']; ?>','Peng. Tambahan Pasangan','peng_tambahanpasangan','Data Keuangan','tb_keuangan');
                     //           simpannasabahDetail('<?php echo $db['no_aplikasi']; ?>','peng_tambahanpasangan2','s_penghasilan','<?php echo $db['s_penghasilan']; ?>','<?php echo $ww['peng_tambahanpasangan2']; ?>','Peng. Tambahan Pasangan 2','peng_tambahanpasangan2','Data Keuangan','tb_keuangan');
