	   ...
	   //	var string = "kd_cabang="+kd_cabang+"&nm_cabang="+nm_cabang;
		...
		if(status_rumah==0){
         ...
         if(radius.length==0){
			...
			cache	: false,
			success	: function(data){
				   message('success', 'Data berhasil di verifikasi');
                            tampil_data('<?php echo $aplikasi; ?>','updatedata','verifikasi','formpembiayaan','2');
...
<tr>
    ...
    <td>:</td>
    <td> <div class="col-lg-5"><input type="text" class="form-control " name="nm_lengkap" id="nm_lengkap" size="30" maxlength="50" value="<?php echo $db['nm_lengkap']; ?>"  size="50" Placeholder="Isi Secara otomatis" /></div></td>
</tr>
<tr>
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><input type="text" class="form-control <?php echo $style; ?>" name="no_identitas" id="no_identitas"  size="50" maxlength="50" value="<?php echo $db['no_identitas']; ?>"  onKeyUp="return checkInput(this);" /></div></td>
</tr>
<tr>
...
<tr>
    ...
    <td>:</td>
    <td><div class="col-lg-5"><select name="id_card" class="js-example-basic-single js-states form-control" id="id_card" >
    <option value="0">-Pilih-</option>
        <?php
...
<tr>
	<td width=20%>Kodepos</td>
    <td>:</td>
    <td><div class="col-lg-5"><input type="search" class="form-control" id="kdpos_tinggal" name="kdpos_tinggal" maxlength="50" size="20" value="<?php echo $db['kdpos_tinggal']; ?>" /> <button type="button"  class="btn btn-info btn-sm" onclick="datakodepos('<?php echo $db['no_aplikasi'];?>','detail','kdposintinggal')"><i class="glyphicon glyphicon-plus"></i>Pilih Kodepos</button></div> </td>
</tr>
<tr>
	<td width=20%>Kelurahan</td>
    <td>:</td>
